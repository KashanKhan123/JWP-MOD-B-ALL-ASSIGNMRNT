...
export default function SectionWithTextAndCarousel() {
  ...
  const items = [
    {
      img: 'https://plus.unsplash.com/premium_photo-1667251759182-a10feb7dbfd0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c21hbGwlMjBpbWd8ZW58MHx8MHx8fDA%3D',
      title: 'Cars',
